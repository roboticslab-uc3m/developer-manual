...
## Asking questions
* **If you have a question, do a search first on our **[**wiki**](http://robots.uc3m.es/)** and among open and closed issues of the repository associated to your project**. In case you don't find the right answer, **open an issue in said repository (or at [QA](https://github.com/roboticslab-uc3m/questions-and-answers) if it extremely generic) or add a comment in the **_**Discussion**_** tab on the wiki**. Pros:
